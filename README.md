...
**T-RDE v1.0:** [`docs/t_rde_v_1.md`](docs/t_rde_v_1.md) · [`trde.config.json`](trde.config.json) · [`docs/trace_maps/m3-minimal-ui-l1.yaml`](docs/trace_maps/m3-minimal-ui-l1.yaml)
